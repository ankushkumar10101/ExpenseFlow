...
export default function TransactionModal() {
  ...
  useEffect(() => {
    if (editingTransaction) {
      ...
      setTitle(editingTransaction.title || editingTransaction.expense || "");
      setAmount(editingTransaction.amount || 0);
      setCategory(editingTransaction.category || "Other");
      setNotes(editingTransaction.notes || editingTransaction.note || "");
    }
  }, [editingTransaction]);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      // Send both standard (title, notes) and legacy (expense, note) fields for full synchronization
      const payload = {
        title,
        expense: title,
  ...
  return (
    <Modal
      ...
      onHide={closeModal}
      centered
      contentClassName="card-custom border-0 shadow-lg"
      ...
      <Modal.Body className="p-4">
        <form onSubmit={handleSubmit}>
          ...
          <div className="d-flex justify-content-center mb-4">
            <div
              className="bg-light p-1 rounded-pill d-inline-flex position-relative"
          ...
          <div className="mb-4 text-center">
            ...
            <div className="d-flex justify-content-center align-items-center">
              <span
                className={`display-4 fw-bold me-1 ${type === "expense" ? "text-purple" : "text-success"
                  }`}
              >
                $
              </span>
          ...
          <div className="row g-3 mb-3">
            <div className="col-12">
              <div className="form-floating">
                <input
                  ...
                  required
                />
                <label htmlFor="titleInput" className="text-muted">
                  Title
                </label>
              </div>
            </div>
            <div className="col-12">
              <div className="dropdown w-100">
                ...
                <ul
                  className="dropdown-menu w-100 border-0 shadow-lg rounded-3 mt-1"
          ...
          <div className="mb-4">
            <div className="form-floating">
              ...
              />
              <label htmlFor="notesInput" className="text-muted">
                Note (Optional)
              </label>
            </div>
          </div>
